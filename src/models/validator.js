...
async function InsertValidatorInfo(public_key, name, email, icon, website, links, details) {
    return new Promise((resolve, reject) => {
...
module.exports = {
    CreateValidatorInfoTable, InsertValidatorInfo, GetValidator,
    DropValidatorInfo, DeleteValidatorInfo, GetValidatorInfoByName,
    GetValidatorsInfoWithNameAndPublicKey, UpdateEmail,
    UpdateName, UpdateLinks, UpdateWebsite,
    GetCurrentEraValidator, GetTotalStakeCurrentEra,
    GetTotalStakeNextEra,GetAllValidator, GetTotalValidator,
    GetTotalActiveValidator,GetNextEraValidator,
    GetRangeValidator,GetValidatorInfo,GetTotalActiveBids
}
