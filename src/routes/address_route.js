...
router.route("/update").post(authentication_required, address_controller.UpdateAddress);
router.route("/add").post(authentication_required, address_controller.AddAddress);
router.route("/delete/:address").get(authentication_required, address_controller.DeleteAddress);
