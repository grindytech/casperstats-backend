...
module.exports = {
    GetDeploy: function (req, res) {
        ...
        let command = `./casper-client get-deploy ${hex} --node-address ${process.env.NETWORK_RPC_API}`;
    ...
    GetDeployBlock: function (req, res) {
        ...
        let command = `./casper-client list-deploys --node-address ${process.env.NETWORK_RPC_API}`;
